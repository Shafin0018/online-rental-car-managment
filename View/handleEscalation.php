...
if (isset($_POST['scan'])) {
    $escalation = "All systems normal at " . date("Y-m-d H:i:s");
    $sql = "INSERT INTO escalations (status) VALUES ('$escalation')";
    $conn->query($sql);
}

$result = $conn->query("SELECT * FROM escalations ORDER BY id DESC");
?>
<!DOCTYPE html>
<html>
